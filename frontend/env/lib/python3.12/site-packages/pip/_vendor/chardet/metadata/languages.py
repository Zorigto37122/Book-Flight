...
class Language:
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia components to start from if we're crawling
...
LANGUAGES = {
    ...
    # simple way to get the Latin alphabet components from Wikipedia through
    ...
    "Vietnamese": Language(
        ...
        # dozens of 8-bit Vietnamese code components are
