...
cdef class Loop:
    ...
    async def connect_read_pipe(self, proto_factory, pipe):
        """RegisterForm read pipe in event loop. Set the pipe to non-blocking mode.
    ...
    async def connect_write_pipe(self, proto_factory, pipe):
        """RegisterForm write pipe in event loop.
    ...
    def add_signal_handler(self, sig, callback, *args):
        ...
        try:
            # RegisterForm a dummy signal handler to ask Python to write the signal
